...
from .common import ElectronicStructureLoss, build_cdft_model
from ..geometric.common.trainer import PretrainTrainer
from .spec import CDFTTaskSpec
...
def build_cdft_trainer(
    ...
    *,
    ...
    model = build_cdft_model(cfg, model_spec, task_spec).to(device)
    if cfg.init_ckpt:
    ...
    loss_fn = ElectronicStructureLoss(
