...
CONFIG="${CONFIG:-${ROOT_DIR}/configs/gotennet_s_hat/qm9.yaml}"
...
for target in "${TARGETS[@]}"; do
  out_dir="${OUT_ROOT}/qm9_${RUN_FAMILY}_gotennet_s_hat_${target}"
  echo "==> Training GotenNet-S_HAT on QM9 target: ${target}"
