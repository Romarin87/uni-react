...
CONFIG="${CONFIG:-${ROOT_DIR}/configs/gotennet_b_hat/qm9.yaml}"
...
for target in "${TARGETS[@]}"; do
  out_dir="${OUT_ROOT}/qm9_${RUN_FAMILY}_gotennet_b_hat_${target}"
  echo "==> Training GotenNet-B_HAT on QM9 target: ${target}"
